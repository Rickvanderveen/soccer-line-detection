...
from util.loss_monitor import LossMonitor
...
for epoch in range(opt.epoch_count, opt.niter + opt.niter_decay + 1):
    ...
    # TODO: Add matplotlib to monitor (mabye realtime) how losses/errors go
    #       during the epochs
    seg_loss, det_loss = model.get_current_errors()
    lossMonitor.save_loss(epoch, seg_loss, det_loss)
